...
extern void AdMame2x(uae_u8 *srcPtr, u32 srcPitch, /* uae_u8 deltaPtr, */
              uae_u8 *dstPtr, u32 dstPitch, int width, int height);
extern void AdMame2x32(uae_u8 *srcPtr, u32 srcPitch, /* uae_u8 deltaPtr, */
              uae_u8 *dstPtr, u32 dstPitch, int width, int height);
