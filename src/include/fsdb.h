...
typedef struct a_inode_struct {
    ...
    char *aname;   /* Amiga name (relative) */
    char *nname;   /* Host full path */
    char *comment; /* AmigaOS file comment */
    int amigaos_mode;
    uae_u32 uniq;
...
/* name helpers (provided elsewhere) */
...
/* Case-insensitive compare for Amiga names */
...
/* Filesystem-dependent (implemented in fsdb_unix.c) */
...
/* errno -> AmigaDOS mapper (implemented in fsdb_unix.c) */
